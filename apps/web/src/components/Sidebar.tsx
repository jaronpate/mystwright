...
const CollapsibleSection = ({ title, icon, children, alwaysShowWhenActive = false, isActive = false }: CollapsibleSectionProps) => {
                    ...
                    character.role !== "victim" && (
                      <div className="card-character" key={character.id}>
                        <Card
                          ...
                          icon={
                            <div className="character-avatar">
                              {character.image ? <img src={character.image} alt={character.name} /> : character.name.charAt(0)}
                            </div>
                          }
                        />
                      </div>
